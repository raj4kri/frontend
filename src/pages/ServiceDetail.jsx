          ...
          content: (
            <ul style={list}>
              <li style={listItem}>
                ...
                <p>
                  Your phone loses charge quickly even with minimal usage. This
                  usually happens due to battery aging or internal damage. We
                  replace it with a high-quality battery for long-lasting
                  backup.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Overheating while charging or using apps may indicate battery
                  failure. We safely replace faulty batteries to prevent further
                  damage.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  A swollen battery can push the screen out and is dangerous.
                  Immediate replacement is required to avoid risk.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Even when not in use, your battery drops significantly. We fix
                  this issue with proper battery replacement and system check.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Phone turns off even when battery percentage is high. This is
                  a sign of battery health failure.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Battery jumps from 20% to 5% suddenly. We fix inaccurate
...

        {
          ...
          content: (
            <>
              ...
              ✔ Charging + battery combined repair <br />✔ Safe installation
              with proper testing
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ No overheating issues <br />✔ Safe and reliable usage
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Warranty available <br />✔ Experienced technicians
            </>
          ),
        },
      ],
          ...
          content: (
            <ul style={list}>
              <li style={listItem}>
                ...
                <p>
                  Loose, broken, or worn-out charging ports can prevent proper
                  connection. We repair or replace damaged ports for stable
                  charging.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  If your phone takes too long to charge, it may be due to
                  internal faults or port issues. We diagnose and fix it to
                  restore fast charging.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Phone not charging at all even after connecting the charger.
                  We identify the root cause and fix it quickly.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Cable disconnects easily or doesn’t fit properly. This is
                  usually due to port damage or dirt buildup.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Charging starts and stops again and again. We fix unstable
              ...
              <li style={listItem}>
                ...
                <p>
                  Dust or moisture inside the port can block charging. We clean
                  and repair safely.
                </p>
              </li>
            </ul>
...

        {
          ...
          content: (
            <>
              ...
              ✔ Fast charging issue fix <br />✔ Port cleaning & maintenance
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Safe device usage <br />✔ No frequent disconnection
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Affordable pricing <br />
              ✔ Experienced technicians <br />✔ Warranty on repairs
            </>
          ),
        },
      ],
          ...
          content: (
            <ul style={list}>
              <li style={listItem}>
                ...
                <p>
                  Your phone is unable to detect network or shows very weak
                  signal. We fix antenna and internal hardware issues to restore
                  proper connectivity.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Device not recognizing SIM card due to slot or motherboard
                  issue. We repair SIM slot and internal connections.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Frequent call disconnection or poor voice quality. We improve
                  signal stability for smooth calling.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Network lost after software update or reset. We fix software
                  and modem-related issues.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Internet not working even with active data plan. We
                  troubleshoot APN settings and hardware faults.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Missing IMEI or unknown baseband causing network failure. We
                  repair system-level issues safely.
                </p>
              </li>
            </ul>
          ),
...

        {
          ...
          content: (
            <>
              ...
              ✔ SIM slot repair <br />
              ✔ Network IC repair <br />✔ Software & modem fix
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Fast mobile data <br />✔ No more call drops
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Affordable pricing <br />
              ✔ Skilled technicians <br />✔ Warranty on service
            </>
          ),
        },
      ],
          ...
          content: (
            <ul style={list}>
              <li style={listItem}>
                ...
                <p>
                  Locked out of your phone due to forgotten pattern? We safely
                  remove pattern lock without damaging your device.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Unable to access your phone due to forgotten PIN or password.
                  We unlock it securely and quickly.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Stuck on Google verification after factory reset? We bypass
                  FRP lock and restore access.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Unable to remember your Google account details. We help
                  recover access to your device.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Bought a used phone that is locked? We unlock it and make it
                  usable again.
                </p>
              </li>
            </ul>
...

        {
          ...
          content: (
            <>
              ...
              ✔ Password removal <br />
              ✔ FRP (Google lock) bypass <br />✔ Secure unlocking with latest
              tools
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ No data loss (when possible) <br />✔ Works on all major brands
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Affordable pricing <br />✔ 100% safe process
            </>
          ),
        },
      ],
          ...
          content: (
            <ul style={list}>
              <li style={listItem}>
                ...
                <p>
                  Phone not turning on or completely dead. This is usually
                  caused by motherboard failure. We diagnose and repair it using
                  advanced tools.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Exposure to water can damage internal circuits. We perform
                  deep cleaning and chip-level repair to restore functionality.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Power-related faults causing phone not to start or heat up. We
                  fix short circuits at the motherboard level.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Phone vibrates or rings but screen is blank. This may be due
                  to display IC or motherboard fault.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Issues like no signal or charging failure caused by damaged IC
                  chips. We repair or replace faulty components.
                </p>
              </li>
              ...
              <li style={listItem}>
                ...
                <p>
                  Phone restarting automatically or overheating due to
...

        {
          ...
          content: (
            <>
              ...
              ✔ Power IC & charging IC repair <br />✔ Complete motherboard
              diagnosis
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Extend phone life <br />✔ Reliable long-term performance
            </>
          ),
        },

        {
          ...
          content: (
            <>
              ...
              ✔ Affordable pricing <br />✔ Warranty on repairs
            </>
          ),
        },
      ],
